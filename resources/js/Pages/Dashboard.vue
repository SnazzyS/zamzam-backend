    ...
    <div class="space-y-6 font-sans antialiased">
        ...
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div class="bg-white p-4">
                ...
                <p class="text-2xl font-semibold text-slate-900 mt-1">{{ stats.totalTrips }}</p>
            </div>

            <div class="bg-white p-4">
                <p class="text-sm text-slate-500">Active Trips</p>
                <p class="text-2xl font-semibold text-slate-900 mt-1">{{ stats.activeTrips }}</p>
            </div>

            <div class="bg-white p-4">
                <p class="text-sm text-slate-500">Total Customers</p>
                <p class="text-2xl font-semibold text-slate-900 mt-1">{{ stats.totalCustomers }}</p>
            </div>
        </div>
            ...
            <div class="p-4">
                <div v-if="filteredTrips.length > 0" class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    <div
                        ...
                        :key="trip.id"
                        class="group relative bg-slate-50 rounded-lg transition hover:bg-slate-100"
                    >
                        <Link
                        ...
                        >
                            <div class="mb-3 flex items-start justify-between gap-3">
                                <h3 class="font-semibold text-slate-900 group-hover:text-blue-600">{{ trip.name }}</h3>
                                <div class="flex items-center gap-2">
                                    ...
                                    <button
                                        type="button"
                                        class="inline-flex h-7 w-7 items-center justify-center rounded-md bg-white text-slate-500 transition hover:text-blue-600"
